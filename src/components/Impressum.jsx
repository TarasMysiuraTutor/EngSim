...
Use of the calculators is at your own risk. For professional calculations, please consult a qualified engineer.`,
      ...
      liabilityText:
        "Our offer contains links to external third-party websites over whose content we have no influence. The respective provider or operator of the pages is always responsible for the content of the linked pages.",
    },
    uk: {
      title: "Імпресум",
...
Використання калькуляторів здійснюється на власний ризик. Для професійних розрахунків проконсультуйтеся з кваліфікованим інженером.`,
      ...
      copyrightText:
        "Вміст та роботи, створені операторами сайту на цих сторінках, підпадають під дію німецького авторського права.",
      liability: "Відповідальність за посилання",
      liabilityText:
        "Наша пропозиція містить посилання на зовнішні веб-сайти третіх сторін, на вміст яких ми не маємо впливу. За вміст пов'язаних сторінок завжди відповідає відповідний провайдер або оператор сторінок.",
    },
    ru: {
      title: "Импрессум",
...
Использование калькуляторов осуществляется на ваш собственный риск. Для профессиональных расчетов проконсультируйтесь с квалифицированным инженером.`,
      ...
      copyrightText:
        "Содержание и работы, созданные операторами сайта на этих страницах, подпадают под действие немецкого авторского права.",
      liability: "Ответственность за ссылки",
      liabilityText:
        "Наше предложение содержит ссылки на внешние веб-сайты третьих сторон, на содержание которых мы не имеем влияния. За содержание связанных страниц всегда отвечает соответствующий провайдер или оператор страниц.",
    },
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-300">
          ...
          <div>
            ...
            <p className="text-gray-300">{t.copyrightText}</p>
          </div>
