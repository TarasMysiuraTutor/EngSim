...
const Hero = ({ t }) => {
  ...
  const formulas = [
    ...
    { latex: 'E = \\frac{\\sigma}{\\varepsilon}', style: 'top-[8%] left-[15%]' },
    ...
    { latex: 'Q = \\frac{\\lambda A\\Delta T}{\\delta}', style: 'top-[22%] left-[32%]' },
    { latex: 'H = \\frac{P}{\\rho g}', style: 'top-[21%] left-[52%]' },
    { latex: 'W = \\frac{\\pi d^3}{16}', style: 'top-[20%] left-[72%]' },
    
    { latex: '\\varepsilon = \\frac{\\Delta L}{L}', style: 'top-[20%] right-[12%]' },
    { latex: '\\alpha = \\frac{Nu \\cdot \\lambda}{L}', style: 'top-[22%] right-[32%]' },
    ...
    { latex: 'We = \\frac{\\rho v^2L}{\\sigma}', style: 'top-[89%] right-[2%]' },
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {formulas.map((formula, i) => (
            ...
            >
              <div dangerouslySetInnerHTML={{ __html: renderFormula(formula.latex) }} />
            </div>
          ))}
        </div>
