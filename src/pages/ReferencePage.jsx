    ...
    uk: [
      {
        ...
        icon: '🔢',
        title: 'Математика',
        description: 'Геометрія, тригонометрія, алгебра, диференціальні рівняння',
        items: '25+ формул',
    ...
    ru: [
      {
        ...
        icon: '🔢',
        title: 'Математика',
        description: 'Геометрия, тригонометрия, алгебра, дифференциальные уравнения',
        items: '25+ формул',
        color: 'from-blue-500 to-cyan-500'
      },
      {
    ...
    de: [
      {
        ...
        icon: '🔢',
        title: 'Mathematik',
        description: 'Geometrie, Trigonometrie, Algebra, Differentialgleichungen',
        items: '25+ Formeln',
        color: 'from-blue-500 to-cyan-500'
      },
      {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://tarasmysiuratutor.github.io/EngSim/reference" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                {currentLang === 'uk' && 'Професійні формули, таблиці та стандарти для інженерних розрахунків'}
                {currentLang === 'ru' && 'Профессиональные формулы, таблицы и стандарты для инженерных расчетов'}
                {currentLang === 'en' && 'Professional formulas, tables and standards for engineering calculations'}
                {currentLang === 'de' && 'Professionelle Formeln, Tabellen und Standards für technische Berechnungen'}
              </p>
            </div>
              ...
              {sections[currentLang].map((section) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-blue-500/20">
                    ...
                    <svg className="w-5 h-5 text-blue-400 transform group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-16 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
                {currentLang === 'uk' && 'Всі дані взяті з європейських (EN, ISO) та українських (ДСТУ, ДБН) стандартів, а також з перевірених інженерних довідників'}
                {currentLang === 'ru' && 'Все данные взяты из европейских (EN, ISO) и украинских (ДСТУ, ДБН) стандартов, а также из проверенных инженерных справочников'}
                {currentLang === 'en' && 'All data is taken from European (EN, ISO) and Ukrainian (DSTU, DBN) standards, as well as verified engineering handbooks'}
                {currentLang === 'de' && 'Alle Daten stammen aus europäischen (EN, ISO) und ukrainischen (DSTU, DBN) Standards sowie verifizierten technischen Handbüchern'}
              </p>
            </div>
          </div>
        </div>
