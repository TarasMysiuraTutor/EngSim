// src/pages/ReferenceHydraulicsPage.jsx
import React, { useState, useEffect, useRef } from "react";
import { Link } from "react-router-dom";
import { Helmet } from "react-helmet-async";
import Navbar from "../components/Navbar";
import Footer from "../components/Footer";
import { hydraulicsReferenceData } from "../data/reference/hydraulic/index";
...
//   useEffect(() => {
//     if (isLoaded && containerRef.current && latex) {
//       try {
...
//       }
//     }
//   }, [latex, inline, isLoaded]);

//   return (
//     <div
//       ref={containerRef}
//       className={inline ? "inline-block" : "text-3xl my-4"}
//     >
//       {!isLoaded && latex}
//     </div>
//   );
...
const ReferenceHydraulicsPage = ({ currentLang, setCurrentLang, t }) => {
  const { formulas, tables, files } = hydraulicsReferenceData;
  ...
  const categories = {
    uk: [
      ...
      { id: "pressure", name: "Тиск і напір", icon: "📊" },
      { id: "flow", name: "Потоки", icon: "🌊" },
      { id: "pumps", name: "Насоси", icon: "⚙️" },
      { id: "resistance", name: "Опори", icon: "🔧" },
    ],
    ru: [
      { id: "all", name: "Все", icon: "📚" },
      { id: "basics", name: "Основы", icon: "💧" },
      { id: "pressure", name: "Давление и напор", icon: "📊" },
      { id: "flow", name: "Потоки", icon: "🌊" },
      { id: "pumps", name: "Насосы", icon: "⚙️" },
      { id: "resistance", name: "Сопротивления", icon: "🔧" },
    ],
    en: [
      { id: "all", name: "All", icon: "📚" },
      { id: "basics", name: "Basics", icon: "💧" },
      { id: "pressure", name: "Pressure & Head", icon: "📊" },
      { id: "flow", name: "Flow", icon: "🌊" },
      { id: "pumps", name: "Pumps", icon: "⚙️" },
      { id: "resistance", name: "Resistance", icon: "🔧" },
    ],
    de: [
      { id: "all", name: "Alle", icon: "📚" },
      { id: "basics", name: "Grundlagen", icon: "💧" },
      { id: "pressure", name: "Druck & Höhe", icon: "📊" },
      { id: "flow", name: "Strömung", icon: "🌊" },
      { id: "pumps", name: "Pumpen", icon: "⚙️" },
      { id: "resistance", name: "Widerstand", icon: "🔧" },
    ],
  };
  // Фільтрація формул
  ...
  const pageTitle = {
    uk: "Гідравліка | Довідка | EngSim",
    ru: "Гидравлика | Справочник | EngSim",
    en: "Hydraulics | Reference | EngSim",
    de: "Hydraulik | Referenz | EngSim",
  };
  return (
    <>
      <Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <nav className="mb-8 text-sm">
              ...
              <span className="text-gray-400">
                {currentLang === "uk" && "Гідравліка"}
                {currentLang === "ru" && "Гидравлика"}
                {currentLang === "en" && "Hydraulics"}
                {currentLang === "de" && "Hydraulik"}
              </span>
            </nav>
                      ...
                      <div className="pt-4 mt-4 border-t border-blue-500/20">
                        ...
                        {table.source.description && (
                          <p className="text-xs text-gray-500 mt-1">
                            {table.source.description[currentLang]}
                          </p>
                        )}
                      </div>
                    )}
...
export default ReferenceHydraulicsPage;
